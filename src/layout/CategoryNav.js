    ...
    return (
        <nav className="bg-white text-black text-xl">
            <div className="flex justify-between items-center">
                ...
                <Link to={'/items/bottom'} className="flex-grow text-center hover:bg-gray-300 py-3 px-2 rounded-full">BOTTOM</Link>
                <Link to={'/items/outer'} className="flex-grow text-center hover:bg-gray-300 py-3 px-2 rounded-full">OUTER</Link>
                <Link to={'/items/hat'} className="flex-grow text-center hover:bg-gray-300 py-3 px-2 rounded-full">HAT</Link>
